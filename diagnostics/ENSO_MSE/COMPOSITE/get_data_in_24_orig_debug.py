...
def get_data_in_24(imax, jmax, zmax,  ttmax, years,  iy2, variable,  tmax24,  dataout, prefix,  prefix2, undef, undef2):
    ...
    print "get_data_in_24: (i,j,z,t) = ({},{},{},{})".format(imax,jmax,zmax,tmax24)
    print "get_data_in_24: var={}, clima={}, vvar = {}".format(variable, prefix2, prefix)
    print "get_data_in_24: undef={}, undef2={}".format(("%.8g" % undef), ("%.8g" % undef2))
    im1 = 1
    im2 = 24
    tmax12 = 12
        ...
        for im in range (im1, im2+1):
            ...
            if( iyy <= iy2 ):
                ...
                if (os.path.exists( namein)):
                    ...
                    print " exiting  get_data_in_24.py" 
                    sys.exit()
                print "{} invalid entries found in {}".format(inval_counter, namein)
